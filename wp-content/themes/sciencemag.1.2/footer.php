	...
	<div class="modal__body">
		...
		<div class="modal__text">
			<div class="modal__text__header">
				...
				<span>MÅNATLIGT NYHETSBREV</span>
			</div>
			<div class="modal__content">
				<p>Förlåt för att vi stör, men:<br/><br/>Anmäl dig till vårt månatliga nyhetsbrev
					för att få en sammanfattning på alla nypublicerade artiklar på Partikular.</p>
			</div>
			<div class="modal__form">
				<form action="https://partikular.us5.list-manage.com/subscribe/post?u=6b46285289139ed51ecb621d1&amp;id=d99baed735" method="post" target="_blank">
					...
					<input type="submit" value="Anmäl dig ⬈" name="subscribe" id="mc-embedded-subscribe">
				</form>
			</div>
...
<div class="sciencemag__donation__modal" id="donate__button__click__modal">
	<div class="donation__modal__body">
		...
		<img src="<?php echo get_template_directory_uri() . '/qrcode.svg';?>" id="swishqrcode">
