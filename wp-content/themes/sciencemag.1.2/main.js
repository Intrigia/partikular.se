...
function OpenSearchWindow() {
  if (searchwindow_isopen) {
    ...
    document.querySelector(".sciencemag__navbar__search").style.filter = "invert(0)";
    searchwindow_isopen = false;
  } else {
    if (window.innerWidth < 500) {
      document.querySelector(".sciencemag__search__wrap").style.height = "100px";
    } else {
    document.querySelector(".sciencemag__search__wrap").style.height = "130px";
    }
    document.querySelector(".sciencemag__navbar__search").style.filter = "invert(1)";
    setTimeout(function () {
