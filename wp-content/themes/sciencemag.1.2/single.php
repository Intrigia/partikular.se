...
.wp-block-group {border-color: <?php echo $categorycolour; ?>;}
...
function ToCategory(categoryname) {location.assign('http://www.vetenskapstidningen.local/category' + categoryname);}
