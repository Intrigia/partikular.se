...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		...
		<div class="temp-referrer-message" style="width:calc(100% - 30px);position:fixed;top:70px;padding: 9px 15px;background: #202020;color:white;font-size:13px;z-index:1;">
			<span>Just nu på Partikular – Sök till nästa års styrelse. <a href="https://www.partikular.se/sok-till-styrelsen/" style="font-weight: bold;color: #ff01c7;">Klicka här för att läsa mer</a>
		</div>
	</header><!-- #masthead -->
