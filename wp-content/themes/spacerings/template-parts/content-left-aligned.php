<?php
/**
 * Template part for displaying posts left aligned on the home page.
 *
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
  <div class="sciencemag__extraposts__wrapper">
    <a href="<?php the_permalink(); ?>">
    <div class="sciencemag__post__planet extraposts__planet" style="border-color:<?php echo $categorycolour; ?>;
    ...
    <div>
      <div class="sciencemag__wrapper__title extraposts__title">
